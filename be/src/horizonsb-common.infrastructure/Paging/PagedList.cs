...
namespace horizonsb.common.infrastructure.Paging
{
  public class PagedList<T> : List<T>
  {
    ...
    public PagedList(IEnumerable<T> items, int count, int? pageNumber = -1, int? pageSize = -1)
    {
      TotalCount = count;
